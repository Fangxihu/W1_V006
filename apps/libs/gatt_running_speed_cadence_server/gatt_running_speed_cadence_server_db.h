...
#define HANDLE_RUNNING_SPEED_AND_CADENCE_EXTENSION (0x0006)
#define HANDLE_RUNNING_SPEED_AND_CADENCE_EXTENSION_CLIENT_CONFIG (0x0007)
#define HANDLE_RSC_FEATURE              (0x0009)
