...
static void appAvrcpHandleRegisterNotificationInd(avInstanceTaskData *theInst, AVRCP_REGISTER_NOTIFICATION_IND_T *ind)
{
    ...
    else
    {
        ...
        appAvrcpSetEventRegistered(theInst, ind->event_id);
...
{
    if (appAvrcpIsConnected(theInst) && appAvrcpIsEventRegistered(theInst, avrcp_event_volume_changed))
    {
        ...
        appAvrcpClearEventRegistered(theInst, avrcp_event_volume_changed);
    }
    else
    {
...
void appAvAvrcpPlayStatusNotification(avInstanceTaskData *theInst, avrcp_play_status play_status)
{
    ...
    if (appAvrcpIsConnected(theInst) && appAvrcpIsEventRegistered(theInst, avrcp_event_playback_status_changed))
    {
        ...
        appAvrcpClearEventRegistered(theInst, avrcp_event_playback_status_changed);
    }
    else
    {
