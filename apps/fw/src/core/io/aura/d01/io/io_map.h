...
/* *************************************************************************  *
   ...
   $Id: //depot/app_ss/ADK6_releases/ADK6p3/fw/src/core/io/aura/d01/io/io_map.h#1 $
   $Name$
   $Source$
...
#ifndef __IO_MAP_H__IO_MAP_MODULE_SQIF_DATAPATH_TBUS_BRIDGE
#define __IO_MAP_H__IO_MAP_MODULE_SQIF_DATAPATH_TBUS_BRIDGE

/* -- sqif_datapath_tbus_bridge -- SQIF datapath to TBus bridge block registers -- */

/* Declarations of read/write/mixed registers */
extern volatile uint32  SQIF_DATAPATH_TBUS_BRIDGE_ACCESS_CTRL;  /* RW   4 bits */
extern volatile uint32  SQIF_DATAPATH_TBUS_BRIDGE_ENABLE;    /* RW   1 bits */
extern volatile sqif_datapath_tbus_bridge__mutex_lock_enum  SQIF_DATAPATH_TBUS_BRIDGE_MUTEX_LOCK;  /* RW   4 bits */
extern volatile uint32  SQIF_DATAPATH_TBUS_BRIDGE_REMOTE_ADDR_OFFSET;  /* RW  32 bits */
extern volatile uint32  SQIF_DATAPATH_TBUS_BRIDGE_REMOTE_BLOCK_ID;  /* RW   4 bits */
extern volatile uint32  SQIF_DATAPATH_TBUS_BRIDGE_REMOTE_CONFIG;  /* RW   1 bits */
extern volatile uint32  SQIF_DATAPATH_TBUS_BRIDGE_REMOTE_CONTROL;  /* RW  10 bits */
extern volatile uint32  SQIF_DATAPATH_TBUS_BRIDGE_REMOTE_SS_ID;  /* RW   4 bits */
extern volatile uint32  SQIF_DATAPATH_TBUS_BRIDGE_WINDOW_LOWER;  /* RW  32 bits */
extern volatile uint32  SQIF_DATAPATH_TBUS_BRIDGE_WINDOW_UPPER;  /* RW  32 bits */

/* Declarations of read only registers */
extern volatile uint32  SQIF_DATAPATH_TBUS_BRIDGE_REMOTE_DATA_LSW;  /* R   32 bits */
extern volatile uint32  SQIF_DATAPATH_TBUS_BRIDGE_REMOTE_DATA_MSW;  /* R   32 bits */
extern volatile uint32  SQIF_DATAPATH_TBUS_BRIDGE_REMOTE_STATUS;  /* R    6 bits */

#endif /* __IO_MAP_H__IO_MAP_MODULE_SQIF_DATAPATH_TBUS_BRIDGE */
#endif /* !defined(IO_DEFS_LIMIT_MODULES) || defined(IO_DEFS_MODULE_SQIF_DATAPATH_TBUS_BRIDGE) */
...
#ifndef __IO_MAP_H__IO_MAP_MODULE_READ_DECRYPT
#define __IO_MAP_H__IO_MAP_MODULE_READ_DECRYPT

/* -- read_decrypt -- Inline SQIF read decryption block regigsters -- */

/* Declarations of read/write/mixed registers */
extern volatile uint32  READ_DECRYPT_ACCESS_CTRL;            /* RW   4 bits */
extern volatile uint32  READ_DECRYPT_CLEARTEXT_BASE;         /* RW  32 bits */
extern volatile uint32  READ_DECRYPT_CLEARTEXT_SIZE;         /* RW  32 bits */
extern volatile uint32  READ_DECRYPT_CONTROL;                /* RW  12 bits */
extern volatile uint32  READ_DECRYPT_IMAGE_ADDRESS_MASK;     /* RW  16 bits */
extern volatile uint32  READ_DECRYPT_KEY[4];                 /* RW 128 bits */
extern volatile uint32  READ_DECRYPT_KEY_WORD0;              /* RW */
extern volatile uint32  READ_DECRYPT_KEY_WORD1;              /* RW */
extern volatile uint32  READ_DECRYPT_KEY_WORD2;              /* RW */
extern volatile uint32  READ_DECRYPT_KEY_WORD3;              /* RW */
extern volatile uint32  READ_DECRYPT_KEY_ENABLE;             /* RW   1 bits */
extern volatile read_decrypt__mutex_lock_enum  READ_DECRYPT_MUTEX_LOCK;             /* RW   4 bits */
extern volatile uint32  READ_DECRYPT_NONCE[4];               /* RW 128 bits */
extern volatile uint32  READ_DECRYPT_NONCE_WORD0;            /* RW */
extern volatile uint32  READ_DECRYPT_NONCE_WORD1;            /* RW */
extern volatile uint32  READ_DECRYPT_NONCE_WORD2;            /* RW */
extern volatile uint32  READ_DECRYPT_NONCE_WORD3;            /* RW */

/* Declarations of read only registers */
extern volatile uint32  READ_DECRYPT_PERFORMANCE;            /* R   32 bits */

#endif /* __IO_MAP_H__IO_MAP_MODULE_READ_DECRYPT */
#endif /* !defined(IO_DEFS_LIMIT_MODULES) || defined(IO_DEFS_MODULE_READ_DECRYPT) */

#if defined(IO_DEFS_MODULE_APPS_REMOTE_SUBSYSTEM_ACCESSOR) 

#ifndef __IO_MAP_H__IO_MAP_MODULE_APPS_REMOTE_SUBSYSTEM_ACCESSOR
#define __IO_MAP_H__IO_MAP_MODULE_APPS_REMOTE_SUBSYSTEM_ACCESSOR

/* -- apps_remote_subsystem_accessor -- Remote subsystem accessor interface config -- */

/* Declarations of read/write/mixed registers */
extern volatile uint32  REMOTE_SUBSYSTEM_ACCESS_ACCESS_CTRL;  /* RW   4 bits */
extern volatile uint32  REMOTE_SUBSYSTEM_ACCESS_MISC;        /* RW  10 bits */
extern volatile apps_remote_subsystem_accessor__mutex_lock_enum  REMOTE_SUBSYSTEM_ACCESS_MUTEX_LOCK;  /* RW   4 bits */
extern volatile uint32  REMOTE_SUBSYSTEM_ACCESS_REG_BASED_ACCESS_ADDR;  /* RW  32 bits */
extern volatile uint32  REMOTE_SUBSYSTEM_ACCESS_REG_BASED_ACCESS_CTRL;  /* RW  13 bits */
extern volatile uint32  REMOTE_SUBSYSTEM_ACCESS_REG_BASED_ACCESS_TRIG;  /* RW   1 bits */
extern volatile uint32  REMOTE_SUBSYSTEM_ACCESS_REG_BASED_ACCESS_WRITE_DATA;  /* RW  32 bits */
extern volatile uint32  REMOTE_SUBSYSTEM_ACCESS_REG_BASED_CONFIG;  /* RW   3 bits */
extern volatile uint32  REMOTE_SUBSYSTEM_ACCESS_REG_BASED_STATUS_CLEAR;  /* RW   1 bits */
extern volatile uint32  REMOTE_SUBSYSTEM_ACCESS_REM_REGS_WINDOW_CONFIG;  /* RW   2 bits */
extern volatile uint32  REMOTE_SUBSYSTEM_ACCESS_REM_REGS_WINDOW_STATUS_CLEAR;  /* RW   1 bits */
extern volatile uint32  REMOTE_SUBSYSTEM_ACCESS_WINDOW0_CONFIG;  /* RW  12 bits */
extern volatile uint32  REMOTE_SUBSYSTEM_ACCESS_WINDOW0_STATUS_CLEAR;  /* RW   1 bits */
extern volatile uint32  REMOTE_SUBSYSTEM_ACCESS_WINDOW1_CONFIG;  /* RW  12 bits */
extern volatile uint32  REMOTE_SUBSYSTEM_ACCESS_WINDOW1_STATUS_CLEAR;  /* RW   1 bits */

/* Declarations of read only registers */
extern volatile uint32  REMOTE_SUBSYSTEM_ACCESS_REG_BASED_ACCESS_READ_DATA;  /* R   32 bits */
extern volatile uint32  REMOTE_SUBSYSTEM_ACCESS_REG_BASED_STATUS;  /* R    5 bits */
extern volatile uint32  REMOTE_SUBSYSTEM_ACCESS_REM_REGS_WINDOW_STATUS;  /* R    5 bits */
extern volatile uint32  REMOTE_SUBSYSTEM_ACCESS_WINDOW0_STATUS;  /* R    5 bits */
extern volatile uint32  REMOTE_SUBSYSTEM_ACCESS_WINDOW1_STATUS;  /* R    5 bits */

#endif /* __IO_MAP_H__IO_MAP_MODULE_APPS_REMOTE_SUBSYSTEM_ACCESSOR */
#endif /* !defined(IO_DEFS_LIMIT_MODULES) || defined(IO_DEFS_MODULE_APPS_REMOTE_SUBSYSTEM_ACCESSOR) */
...
#ifndef __IO_MAP_H__IO_MAP_MODULE_APPS_BANKED_TBUS_INT_P0
#define __IO_MAP_H__IO_MAP_MODULE_APPS_BANKED_TBUS_INT_P0

/* -- apps_banked_tbus_int_p0 -- Control of banked TBus interrupts for P0 -- */

/* Declarations of read/write/mixed registers */
extern volatile uint32  APPS_BANKED_TBUS_INT_P0_ACCESS_CTRL;  /* RW   4 bits */
extern volatile uint32  APPS_BANKED_TBUS_INT_P0_ENABLES;     /* RW  16 bits */
extern volatile apps_banked_tbus_int_p0__mutex_lock_enum  APPS_BANKED_TBUS_INT_P0_MUTEX_LOCK;  /* RW   4 bits */
extern volatile uint32  APPS_BANKED_TBUS_INT_P0_STATUS;      /* RW  16 bits */

#endif /* __IO_MAP_H__IO_MAP_MODULE_APPS_BANKED_TBUS_INT_P0 */
#endif /* !defined(IO_DEFS_LIMIT_MODULES) || defined(IO_DEFS_MODULE_APPS_BANKED_TBUS_INT_P0) */
...
#ifndef __IO_MAP_H__IO_MAP_MODULE_APPS_BANKED_EXCEPTIONS_P0
#define __IO_MAP_H__IO_MAP_MODULE_APPS_BANKED_EXCEPTIONS_P0

/* -- apps_banked_exceptions_p0 -- Control of banked exceptions for P0 -- */

/* Declarations of read/write/mixed registers */
extern volatile uint32  APPS_BANKED_EXCEPTIONS_P0_ACCESS_CTRL;  /* RW   4 bits */
extern volatile apps_banked_exceptions_p0__exception_source  APPS_BANKED_EXCEPTIONS_P0_ENABLES;   /* RW  20 bits */
extern volatile apps_banked_exceptions_p0__mutex_lock_enum  APPS_BANKED_EXCEPTIONS_P0_MUTEX_LOCK;  /* RW   4 bits */
extern volatile apps_banked_exceptions_p0__exception_source  APPS_BANKED_EXCEPTIONS_P0_STATUS;    /* RW  20 bits */

#endif /* __IO_MAP_H__IO_MAP_MODULE_APPS_BANKED_EXCEPTIONS_P0 */
#endif /* !defined(IO_DEFS_LIMIT_MODULES) || defined(IO_DEFS_MODULE_APPS_BANKED_EXCEPTIONS_P0) */
...
#ifndef __IO_MAP_H__IO_MAP_MODULE_K32_DEBUG_PROG_FLOW
#define __IO_MAP_H__IO_MAP_MODULE_K32_DEBUG_PROG_FLOW
...
/* Declarations of read/write/mixed registers */
extern volatile uint32  DEBUG;                               /* RW  19 bits */
extern volatile uint32  DEBUG_PM_BREAK7_ENABLED;             /* RW   7 bits */
extern volatile uint32  DEBUG_PM_BREAK7_ENABLES;             /* RW   7 bits */
extern volatile uint32  DM_BREAK0_BYTE_SELECT;               /* RW   4 bits */
extern volatile uint32  DM_BREAK0_DATA_MASK;                 /* RW  32 bits */
extern volatile uint32  DM_BREAK0_DATA_VALUE;                /* RW  32 bits */
extern volatile uint32  DM_BREAK0_END_ADDR;                  /* RW  32 bits */
extern volatile uint32  DM_BREAK0_START_ADDR;                /* RW  32 bits */
extern volatile uint32  DM_BREAK1_BYTE_SELECT;               /* RW   4 bits */
extern volatile uint32  DM_BREAK1_DATA_MASK;                 /* RW  32 bits */
extern volatile uint32  DM_BREAK1_DATA_VALUE;                /* RW  32 bits */
extern volatile uint32  DM_BREAK1_END_ADDR;                  /* RW  32 bits */
extern volatile uint32  DM_BREAK1_START_ADDR;                /* RW  32 bits */
extern volatile uint32  EXTERNAL_BREAK;                      /* RW   2 bits */
extern volatile uint32  EXTERNAL_BREAK_STATUS;               /* RW   1 bits */
extern volatile uint32  INTERPROC_BREAK;                     /* RW   2 bits */
extern volatile uint32  PM_BREAK0_ADDR;                      /* RW  32 bits */
extern volatile uint32  PM_BREAK1_ADDR;                      /* RW  32 bits */
extern volatile uint32  PM_BREAK2_ADDR;                      /* RW  32 bits */
extern volatile uint32  PM_BREAK3_ADDR;                      /* RW  32 bits */
extern volatile uint32  PM_BREAK4_ADDR;                      /* RW  32 bits */
extern volatile uint32  PM_BREAK5_ADDR;                      /* RW  32 bits */
extern volatile uint32  PM_BREAK6_ADDR;                      /* RW  32 bits */
extern volatile uint32  PM_BREAK7_ADDR;                      /* RW  32 bits */
extern volatile uint32  REGFILE_PC;                          /* RW  32 bits */

/* Declarations of read only registers */
extern volatile uint32  STATUS;                              /* R   17 bits */

#endif /* __IO_MAP_H__IO_MAP_MODULE_K32_DEBUG_PROG_FLOW */
#endif /* !defined(IO_DEFS_LIMIT_MODULES) || defined(IO_DEFS_MODULE_K32_DEBUG_PROG_FLOW) */
...
#ifndef __IO_MAP_H__IO_MAP_MODULE_SQIF_DATAPATH_BANKED
#define __IO_MAP_H__IO_MAP_MODULE_SQIF_DATAPATH_BANKED

/* -- sqif_datapath_banked -- SQIF Datapath Register Bank. -- */

/* Declarations of read/write/mixed registers */
extern volatile uint32  SQIF_DATAPATH_BANKED_ACCESS_CTRL;    /* RW   4 bits */
extern volatile sqif_datapath_banked__mutex_lock_enum  SQIF_DATAPATH_BANKED_MUTEX_LOCK;     /* RW   4 bits */
extern volatile uint32  SQIF_DATAPATH_PORT_CONTROL;          /* RW   3 bits */
extern volatile uint32  SQIF_DATAPATH_PORT_PARAMETERS;       /* RW  14 bits */
extern volatile uint32  SQIF_DATAPATH_PORT_STATUS;           /* RW   1 bits */

#endif /* __IO_MAP_H__IO_MAP_MODULE_SQIF_DATAPATH_BANKED */
#endif /* !defined(IO_DEFS_LIMIT_MODULES) || defined(IO_DEFS_MODULE_SQIF_DATAPATH_BANKED) */
...
#ifndef __IO_MAP_H__IO_MAP_MODULE_APPS_SYS_APU
#define __IO_MAP_H__IO_MAP_MODULE_APPS_SYS_APU

/* -- apps_sys_apu -- Access Protection Unit (APU) -- Main Register Block. -- */

/* Declarations of read/write/mixed registers */
extern volatile uint32  APPS_SYS_APU_ACCESS_CTRL;            /* RW   4 bits */
extern volatile uint32  APPS_SYS_APU_AREA_CONTROL;           /* RW   3 bits */
extern volatile uint32  APPS_SYS_APU_AREA_SELECT;            /* RW   5 bits */
extern volatile uint32  APPS_SYS_APU_AREA_WINDOW_HI;         /* RW  32 bits */
extern volatile uint32  APPS_SYS_APU_AREA_WINDOW_LO;         /* RW  32 bits */
extern volatile uint32  APPS_SYS_APU_CONTROL;                /* RW   3 bits */
extern volatile uint32  APPS_SYS_APU_FAULT_DATA;             /* RW  32 bits */
extern volatile uint32  APPS_SYS_APU_FAULT_RELEASE_CLEAR;    /* W    1 bits */
extern volatile apps_sys_apu__mutex_lock_enum  APPS_SYS_APU_MUTEX_LOCK;             /* RW   4 bits */

/* Declarations of read only registers */
extern volatile uint32  APPS_SYS_APU_FAULT_ADDRESS;          /* R   32 bits */
extern volatile uint32  APPS_SYS_APU_STATUS;                 /* R    9 bits */

#endif /* __IO_MAP_H__IO_MAP_MODULE_APPS_SYS_APU */
#endif /* !defined(IO_DEFS_LIMIT_MODULES) || defined(IO_DEFS_MODULE_APPS_SYS_APU) */
