...
#ifdef PROCESSOR_P0
   .VAR/DM $_shallow_sleep_clk_div = 0;
#endif
...
.IntPush1_Fp012Fl:
   ...
   rFlags = rFlags AND ~$BR_FLAG_MASK;
#endif
...
#ifdef PROCESSOR_P0
   r2 = M[$VM_REQUEST_CPU0_WRITE_REMOTE_CONFIG];
   r3 = M[$VM_REQUEST_CPU0_READ_REMOTE_CONFIG];
   pushm <r2, r3>;
#endif /* PROCESSOR_P0 */
...
#ifdef PROCESSOR_P0
   popm <r2, r3>;
   M[$VM_REQUEST_CPU0_WRITE_REMOTE_CONFIG] = r2;
   M[$VM_REQUEST_CPU0_READ_REMOTE_CONFIG] = r3;
#endif /* PROCESSOR_P0 */
...
#ifdef PROCESSOR_P0
    // Set clock divider to slow the clock down during shallow sleep
    r1 = M[$_shallow_sleep_clk_div];
    M[$CLKGEN_CORE_CLK_RATE] = r1;
#endif // PROCESSOR_P0
...
.ISR_FDE_Start:
    ...
    .byte   DW_CFA_advance_loc2
    .2byte  .IntPush2_M23L-.IntPush1_Fp012Fl
    .byte   DW_CFA_offset + KalDwarfRegisterNum_RegrMAC
    .byte   0x05
    ...
    .byte   DW_CFA_advance_loc2
    .2byte  .IntPop2_M23L-.IntPush2_M23L
    .byte   DW_CFA_restore + KalDwarfRegisterNum_RegrMAC
    ...
    .byte   DW_CFA_advance_loc2
    .2byte  .IntPop1_Fp012Fl-.IntPop2_M23L
