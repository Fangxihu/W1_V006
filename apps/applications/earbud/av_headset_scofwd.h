...
typedef enum
{
    ...
    SFWD_STATE_CONNECTED            = 5,                        /*!< L2CAP link up, but no traffic */
        SFWD_STATE_CONNECTED_ACTIVE         = 6,                /*!< Chain should be up, but not forwarding */
...
#define appScoFwdCallVoice()        ((void)0)
#define appScoFwdVolumeStart(vol)   ((void)0)
#define appScoFwdVolumeStop(vol)    ((void)0)

#define appScoFwdEnableForwarding()   ((void)0)
#define appScoFwdDisableForwarding()  ((void)0)
