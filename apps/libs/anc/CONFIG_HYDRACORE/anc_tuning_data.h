...
#define ANC_ACTIVE_MODE_TUNING_CONFIG_KEY       (AUDIO_PS_ANC_TUNING(0))
#define ANC_LEAKTHROUGH_MODE_TUNING_CONFIG_KEY  (AUDIO_PS_ANC_TUNING(1))
...
typedef enum
{
    production_anc_path_gain_index_active_mode_instance_0_feed_forward_a,
    production_anc_path_gain_index_active_mode_instance_0_feed_forward_b,
    production_anc_path_gain_index_active_mode_instance_0_feed_back,
    production_anc_path_gain_index_active_mode_instance_1_feed_forward_a,
    production_anc_path_gain_index_active_mode_instance_1_feed_forward_b,
    production_anc_path_gain_index_active_mode_instance_1_feed_back,
    production_anc_path_gain_index_leakthrough_mode_instance_0_feed_forward_a,
    production_anc_path_gain_index_leakthrough_mode_instance_0_feed_forward_b,
    production_anc_path_gain_index_leakthrough_mode_instance_0_feed_back,
    production_anc_path_gain_index_leakthrough_mode_instance_1_feed_forward_a,
    production_anc_path_gain_index_leakthrough_mode_instance_1_feed_forward_b,
    production_anc_path_gain_index_leakthrough_mode_instance_1_feed_back,
