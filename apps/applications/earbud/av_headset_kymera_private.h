...
/*! \brief Handle request to start SCO.
    ...
    \param allow_scofwd Set to TRUE to allow SCO forwarding.
*/
...
/*! \brief Handle request to start SCO forwarding receive.
...
/*! \brief Handle request to stop SCO forwarding receiver. */
void appKymeraHandleInternalScoForwardingStopRx(void);
#else
/*! \brief Handle request to stop SCO forwarding transmit (unsupported). */
