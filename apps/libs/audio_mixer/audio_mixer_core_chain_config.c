...
/******************************************************************************/
static const chain_config_t* getLowPowerCoreChainConfig(bool mono_path_enabled)
{
...
/******************************************************************************/
static const chain_config_t* getCoreChainConfig(bool mono_path_enabled)
{
    if(mono_path_enabled)
...
const chain_config_t* mixerCoreGetChainConfig(connection_type_t connection_type, bool mono_path_enabled)
{
    ...
    if(useLowPowerCore(connection_type))
        return getLowPowerCoreChainConfig(mono_path_enabled);

    if(connection_type == CONNECTION_TYPE_MUSIC_BA_TX)
        return &mixer_ba_tx_config;
     
    return getCoreChainConfig(mono_path_enabled);
}
