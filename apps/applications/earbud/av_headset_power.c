...
static void appPowerDoPowerOff(void)
{
    ...
    // Check whether Curator refused to power off because charger detection is not complete
...
static void appPowerExitInit(void)
{
    ...
    MessageSend(appGetAppTask(), POWER_INIT_CFM, NULL);
}
...
static void appPowerEnterPowerStateTerminatingClientsNotified(void)
{
    ...
    {
        appTaskListMessageSendId(appPowerGetClients(), POWER_SHUTDOWN_PREPARE_IND);
...
static void appPowerExitPowerStateTerminatingClientsResponded(void)
{
    ...
    appTaskListMessageSendId(appPowerGetClients(), POWER_SHUTDOWN_CANCELLED_IND);
}
...
static void appPowerEnterPowerStateSoporificClientsNotified(void)
{
    ...
    appTaskListMessageSendId(appPowerGetClients(), POWER_SLEEP_PREPARE_IND);
...
static void appPowerExitPowerStateSoporificClientsResponded(void)
{
    ...
    appTaskListMessageSendId(appPowerGetClients(), POWER_SLEEP_CANCELLED_IND);
}
...
static void appPowerHandleInternalUIComplete(void)
{
    ...
    if (appPowerNeedsToPowerOff())
    {
        appPowerDoPowerOff();
        /*
         * Return only if power-off was refused due to charger detection ongoing
         * Charger state is checked again later
         */
    }
    appPowerSetState(POWER_STATE_OK);
}
