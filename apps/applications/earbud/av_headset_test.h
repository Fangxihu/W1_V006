...
/*! \brief Determine if INCLUDE_SCOFWD is defined.
    \return bool TRUE if INCLUDE_SCOFWD defined in the build,
                 FALSE otherwise.
*/
bool appTestIsScoFwdIncluded(void);

/*! \brief Determine if INCLUDE_MICFWD is defined.
    \return bool TRUE if INCLUDE_MICFWD defined in the build,
                 FALSE otherwise.
*/
