...
/*******************************************************************************
 ...
 VALUES
    AOV_TRIGGER     - Given audio hasn't seen a request to transition into low
                      power mode, this message is sent 1) by a VAD operator to
                      its client when the VAD operator detects audio activity
                      and if the wake type is unknown/WAKE_ON_VAD, 2) by a VTD
                      operator to its client when the VTD operator detects a
                      trigger phrase and if the wake type is
                      unknown/WAKE_ON_VTD, 3) by a VCI operator to its client
                      when the VCI operator detects a voice command and if the
                      wake type is unknown/WAKE_ON_VCI .
    LATENCY_CHANGED - This  message is sent by the RTP DECODE operator whenever
                      there is an latency change due to an aptX adaptive source
                      change.
...
/*******************************************************************************
 ...
 VALUES
    OPMSG_SPLITTER_UNPACKED - The audio data will be saved as it is. This is the
                              ...
                              activated.
    OPMSG_SPLITTER_PACKED   - Only the MSB 16 bit of the auido sample is saved.
...
/*******************************************************************************
 ...
 VALUES
    ...
    TRIGGER_PHRASE_LOAD            - Requests SVA to use the listed trigger
                                     phrase files
    TRIGGER_PHRASE_UNLOAD          - Requests SVA to unload the listed trigger
                                     phrase files
    STRIP_TRIGGER_PHRASE_FLAG      - Requests SVA to pass through audio data
...
typedef enum
{
    ...
    OPMSG_SVA_ID_SET_MIN_MAX_TRIGGER_PHRASE_LEN = 0x0005
} OPMSG_SVA_ID;
/*******************************************************************************
...
/*******************************************************************************
  ...
  NAME
    OPMSG_SVA_SET_MIN_MAX_TRIGGER_PHRASE_LEN
...
/* The following macros take OPMSG_SVA_SET_MIN_MAX_TRIGGER_PHRASE_LEN *opmsg_sva_set_min_max_trigger_phrase_len_ptr */
#define OPMSG_SVA_SET_MIN_MAX_TRIGGER_PHRASE_LEN_MESSAGE_ID_WORD_OFFSET (0)
#define OPMSG_SVA_SET_MIN_MAX_TRIGGER_PHRASE_LEN_MESSAGE_ID_GET(opmsg_sva_set_min_max_trigger_phrase_len_ptr) ((OPMSG_SVA_ID)(opmsg_sva_set_min_max_trigger_phrase_len_ptr)->_data[0])
#define OPMSG_SVA_SET_MIN_MAX_TRIGGER_PHRASE_LEN_MESSAGE_ID_SET(opmsg_sva_set_min_max_trigger_phrase_len_ptr, message_id) ((opmsg_sva_set_min_max_trigger_phrase_len_ptr)->_data[0] = (uint16)(message_id))
#define OPMSG_SVA_SET_MIN_MAX_TRIGGER_PHRASE_LEN_MIN_LEN_WORD_OFFSET (1)
#define OPMSG_SVA_SET_MIN_MAX_TRIGGER_PHRASE_LEN_MIN_LEN_GET(opmsg_sva_set_min_max_trigger_phrase_len_ptr) ((opmsg_sva_set_min_max_trigger_phrase_len_ptr)->_data[1])
#define OPMSG_SVA_SET_MIN_MAX_TRIGGER_PHRASE_LEN_MIN_LEN_SET(opmsg_sva_set_min_max_trigger_phrase_len_ptr, min_len) ((opmsg_sva_set_min_max_trigger_phrase_len_ptr)->_data[1] = (uint16)(min_len))
#define OPMSG_SVA_SET_MIN_MAX_TRIGGER_PHRASE_LEN_MAX_LEN_WORD_OFFSET (2)
#define OPMSG_SVA_SET_MIN_MAX_TRIGGER_PHRASE_LEN_MAX_LEN_GET(opmsg_sva_set_min_max_trigger_phrase_len_ptr) ((opmsg_sva_set_min_max_trigger_phrase_len_ptr)->_data[2])
#define OPMSG_SVA_SET_MIN_MAX_TRIGGER_PHRASE_LEN_MAX_LEN_SET(opmsg_sva_set_min_max_trigger_phrase_len_ptr, max_len) ((opmsg_sva_set_min_max_trigger_phrase_len_ptr)->_data[2] = (uint16)(max_len))
#define OPMSG_SVA_SET_MIN_MAX_TRIGGER_PHRASE_LEN_WORD_SIZE (3)
/*lint -e(773) allow unparenthesized*/
#define OPMSG_SVA_SET_MIN_MAX_TRIGGER_PHRASE_LEN_CREATE(message_id, min_len, max_len) \
    (uint16)(message_id), \
    (uint16)(min_len), \
    (uint16)(max_len)
#define OPMSG_SVA_SET_MIN_MAX_TRIGGER_PHRASE_LEN_PACK(opmsg_sva_set_min_max_trigger_phrase_len_ptr, message_id, min_len, max_len) \
    do { \
        (opmsg_sva_set_min_max_trigger_phrase_len_ptr)->_data[0] = (uint16)((uint16)(message_id)); \
        (opmsg_sva_set_min_max_trigger_phrase_len_ptr)->_data[1] = (uint16)((uint16)(min_len)); \
        (opmsg_sva_set_min_max_trigger_phrase_len_ptr)->_data[2] = (uint16)((uint16)(max_len)); \
    } while (0)

#define OPMSG_SVA_SET_MIN_MAX_TRIGGER_PHRASE_LEN_MARSHALL(addr, opmsg_sva_set_min_max_trigger_phrase_len_ptr) memcpy((void *)(addr), (void *)(opmsg_sva_set_min_max_trigger_phrase_len_ptr), 3)
#define OPMSG_SVA_SET_MIN_MAX_TRIGGER_PHRASE_LEN_UNMARSHALL(addr, opmsg_sva_set_min_max_trigger_phrase_len_ptr) memcpy((void *)(opmsg_sva_set_min_max_trigger_phrase_len_ptr), (void *)(addr), 3)
...
/*******************************************************************************
  ...
  MEMBERS
    message_id - message id
    location   - The following loactions are supported:
...
/*******************************************************************************
  ...
  MEMBERS
    message_id - message id
    packing    - The following loactions are supported: OPMSG_SPLITTER_UNPACKED
                 - The audio samples are saved without losing precision.
                 OPMSG_SPLITTER_PACKED - Only the MSB 16 bit of the auido sample
                 is saved.
...
/*******************************************************************************
  ...
  MEMBERS
    message_id - message id
    mode       - The following loactions are supported: OPMSG_SPLITTER_UNPACKED
                 - The audio samples are saved without losing precision.
                 OPMSG_SPLITTER_PACKED - Only the MSB 16 bit of the auido sample
                 is saved.
    size       - The minimum tag size length in octets if the mode is
                 OPMSG_SPLITTER_UNPACKED.
