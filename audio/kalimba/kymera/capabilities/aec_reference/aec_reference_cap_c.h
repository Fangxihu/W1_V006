...
/* Capability Version */
#define AEC_REFERENCE_CAP_VERSION_MINOR            3
...
*/
#define AEC_REF_RESAMPLER_TEMP_BUF_SIZE 204
...
typedef struct aec_ref_root {
    ...
    bool        spkr_mic_in_same_clock; /* flag showing speaker and mic have same clock source */
#ifdef INSTALL_DELEGATE_RATE_ADJUST_SUPPORT
