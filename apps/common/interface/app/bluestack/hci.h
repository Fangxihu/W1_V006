...
#define HCI_ULP_ENHANCED_RECEIVER_TEST_PARAM_LEN                    ((uint8_t)  4)
#define HCI_ULP_ENHANCED_TRANSMITTER_TEST_PARAM_LEN                 ((uint8_t)  5)
...
typedef struct
{
    ...
    uint8_t                  mod_index;
     /*
     * The pointers below, point to a byte array of size 1octet * (num_octets - 3).
     * The value 3 comes from the other parameters (rx_channel, phy and mod-index).
    uint8_t                  *unknown[num_octets - 3];*/
...
typedef struct
{
    ...
    uint8_t                  phy;
     /*
     * The pointers below, point to a byte array of size 1octet * (num_octets - 4).
     * The value 4 comes from the other parameters (rx_channel, phy and mod-index).
    uint8_t                  *unknown[num_octets - 4];*/
