 ...
 * \internal The 
 * bitserial hardware operation is described in <a href="http://cognidox.europe.root.pri/vdocs/CS-205869-SP-F.pdf">CS-205869-SP-F</a> 
 * \endinternal
 * The lower hardware interface documentation can be found in 
 * /app_ss/main/fw/src/core/io/crescendo/dev/doc/main.html.
 * This is designed to be included by the \c bitserial module and not used 
...
/**
 * This is defined for Hawkeye but it's not used here.
 */
