...
static Source getAnyAncMicSourceForInstance(audio_anc_instance instance)
{
	...
	return AudioPluginGetMicSource(*ancConfigDataGetMicForMicPath(mic_path), ancConfigDataGetAudioChannelForMicPath(mic_path));
}
...
static anc_instance_config_t * getInstanceConfig(audio_anc_instance instance)
{
